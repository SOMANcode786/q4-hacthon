...
- [x] T006 Setup Docusaurus configuration with custom theme in book/docusaurus.config.js
...
- [x] T016 [P] [US1] Create Chapter model in backend/src/models/chapter.py (based on data-model.md)
- [x] T017 [P] [US1] Create ContentChunk model in backend/src/models/content_chunk.py (based on data-model.md)
- [x] T018 [US1] Implement ChapterService in backend/src/services/chapter_service.py (depends on T016)
- [x] T019 [US1] Implement ContentChunkService in backend/src/services/content_chunk_service.py (depends on T017)
- [x] T020 [US1] Implement /api/content/chapters endpoint in backend/src/api/content_routes.py
- [x] T021 [US1] Implement /api/content/chapters/{chapterId} endpoint in backend/src/api/content_routes.py
- [x] T022 [US1] Add chapter validation logic in backend/src/lib/chapter_validator.py
- [x] T023 [US1] Create basic book sidebar structure in book/sidebars.js
- [x] T024 [US1] Create Module 1: Introduction to Physical AI chapter in book/docs/introduction.md
- [x] T025 [US1] Create Module 2: The Robotic Nervous System (ROS 2) chapter in book/docs/ros2.md
- [x] T026 [US1] Create Module 3: The Digital Twin (Gazebo & Unity) chapter in book/docs/digital-twin.md
- [x] T027 [US1] Create Module 4: The AI-Robot Brain (NVIDIA Isaac) chapter in book/docs/ai-robot-brain.md
- [x] T028 [US1] Create Module 5: Vision-Language-Action Systems (VLA) chapter in book/docs/vla.md
- [x] T029 [US1] Create Module 6: Humanoid Robotics Architecture chapter in book/docs/humanoid-arch.md
- [x] T030 [US1] Create Module 7: RAG Chatbot Integration chapter in book/docs/rag-integration.md
- [x] T031 [US1] Create Module 8: Capstone: The Autonomous Humanoid chapter in book/docs/capstone.md
- [x] T032 [US1] Add basic styling and layout for book content in book/src/css/
- [x] T033 [US1] Add diagrams and code examples to each chapter following APA citation format
- [x] T034 [US1] Implement build validation to ensure 10,000-15,000 word target is met
...
- [x] T037 [P] [US2] Create RAGConversation model in backend/src/models/conversation.py (based on data-model.md)
- [x] T038 [P] [US2] Create RAGQuery model in backend/src/models/query.py (based on data-model.md)
- [x] T039 [US2] Implement RAGConversationService in backend/src/services/conversation_service.py (depends on T037)
- [x] T040 [US2] Implement RAGQueryService in backend/src/services/query_service.py (depends on T038)
- [x] T041 [US2] Implement RAGProcessor in backend/src/services/rag_service.py (handles query processing)
- [x] T042 [US2] Implement ContentIndexer in backend/src/services/indexer.py (handles content chunking and embedding)
- [x] T043 [US2] Implement /api/rag/query endpoint in backend/src/api/rag_routes.py
- [x] T044 [US2] Implement /api/rag/validate endpoint in backend/src/api/rag_routes.py
- [x] T045 [US2] Add vector embedding generation using OpenAI in backend/src/lib/embedding_generator.py
- [x] T046 [US2] Add content chunking logic (100-500 words) in backend/src/lib/content_chunker.py
- [x] T047 [US2] Implement similarity search in backend/src/lib/similarity_search.py
- [x] T048 [US2] Create floating chatbot widget component in book/src/components/ChatWidget.jsx
- [x] T049 [US2] Add text selection and Q&A functionality to chatbot widget
- [x] T050 [US2] Implement chatbot API integration in book/src/components/ChatWidget.jsx
- [x] T051 [US2] Add source attribution display in chatbot responses
- [x] T052 [US2] Integrate chatbot widget into Docusaurus layout in book/src/theme/Layout.jsx
...
- [x] T056 [US3] Create Gazebo world files for simulation in simulation/gazebo_worlds/
...
- [x] T066 [P] Documentation updates in book/docs/
- [x] T067 Code cleanup and refactoring across all components
- [x] T068 Performance optimization for RAG system (ensure <1.5s response time)
- [x] T069 [P] Additional unit tests (if requested) in backend/tests/unit/ and book/tests/
- [x] T070 Security hardening for API endpoints
- [x] T071 Run quickstart.md validation to ensure all instructions work
- [x] T072 Setup GitHub Actions for GitHub Pages deployment
- [x] T073 Add plagiarism checking workflow
- [x] T074 Final content review for technical accuracy and APA citations
- [x] T075 Deploy to GitHub Pages
